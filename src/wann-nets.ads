...
package wann.nets is
    ...
    function NNeurons(net : NNet_Interface) return NNet_NeuronIndex is abstract;
    function NLayers (net : NNet_Interface) return NNet_LayerIndex  is abstract;

    -- data storage and propagation
    function  Input_Connections (net : NNet_Interface) return Input_Connection_Array  is abstract;
    function  Output_Connections(net : NNet_Interface) return Output_Connection_Array is abstract;

    --  Neuron handling
    procedure New_Neuron(net : in out NNet_Interface; idx : out NNet_NeuronIndex_Base) is abstract;
    ...
    procedure Del_Neuron(net : in out NNet_Interface; idx : NNet_NeuronIndex) is null;
    -- remove neuron from NNet_Interface, as with New, only for mutable representation

    -- neuron getter and setter
    function  Neuron(net : NNet_Interface; idx : NNet_NeuronIndex) return PN.NeuronClass_Access is abstract;
...
--     function  Layers(net : NNet_Interface) return PL.LayerList_Interface'Class is abstract;
    function  Layer(net : NNet_Interface; idx : NNet_LayerIndex) return PL.Layer_Interface'Class  is abstract;
    procedure Set_Layer(net : in out NNet_Interface; idx : NNet_LayerIndex; L : PL.Layer_Interface'Class) is abstract;
    ...
    function  State(net : Cached_NNet_Interface) return NNet_State_Vector  is abstract;
    procedure SetState(net : in out Cached_NNet_Interface; NSV : NNet_State_Vector) is abstract;
    -- NOTE: GetInputValues should raise  UnsetValueAccess if called before SetInputValues
    function  NeuronValues(net : Cached_NNet_Interface) return Value_Array is abstract;
    ...
    function  Input_Values(net : Stateful_NNet_Interface) return Input_Array is abstract;
    procedure Set_Input_Values(net : in out Stateful_NNet_Interface; IV : Input_Array) is abstract;
    --
    function  Neuron(net : Stateful_NNet_Interface; idx : NNet_NeuronIndex) return PN.Stateful_NeuronClass_Access is abstract;
    ...
    --
    function  AddNeuron(net : in out NNet_Interface'Class; activat : Activation_Type; connects : PN.Input_Connection_Array) return NNet_NeuronIndex;
    procedure AddNeuron(net : in out NNet_Interface'Class; activat : Activation_Type; connects : PN.Input_Connection_Array; idx : out NNet_NeuronIndex);
    ...
    procedure ResetNeuron(net : in out NNet_Interface'Class; idx : NNet_NeuronIndex; activat : Activation_Type; connects : PN.Input_Connection_Array);
    procedure ResetNeuron(net : in out NNet_Interface'Class; idx : NNet_NeuronIndex; connects : PN.Input_Connection_Array);
    ...
    function  PropForward(net : NNet_Interface'Class; IV  : Input_Array)  return Output_Array;
    function  CalcOutputs(net : NNet_Interface'Class; NSV : NNet_Checked_State_Vector) return Output_Array;
    function  CalcOutputs(net : NNet_Interface'Class; NSV : NNet_State_Vector) return Output_Array;
    ...
    -- cached version
    function  GetInputValues(net : Cached_NNet_Interface'Class)      return Input_Array;
    procedure SetInputValues(net : in out Cached_NNet_Interface'Class; IV : Input_Array);

    -- full statefull version
    function  PropForward(net : Stateful_NNet_Interface'Class) return Output_Array;
    function  CalcOutputs(net : Stateful_NNet_Interface'Class) return Output_Array;
